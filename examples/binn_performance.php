...
$write->add_int16(6459);
$write->add_int16(8459);
$write->add_str("Кириллический текст.");
$write->add_str("Вc9Ka9 6uЛебеpда");
$write->add_str("pack — Упаковывает данные в бинарную строку. Идея этой функции была заимствована из Perl и все коды форматирования работают также. Однако, есть некоторые отсутствующие коды форматирования, как, к примеру, код формата Perl \"u\".");
